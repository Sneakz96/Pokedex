function renderPokemons(allPokemons, i) {
    ...
    <div id="pokenumber_${i}">#${i + 1}</div>
    <h2 id="pokeName_${i}">${allPokemons[i]['name']}</h2>
...
function renderDetailCard(foundPokemon, i) {
    ...
    <img class="arrow-back"  onclick="quitDetailCard(${i})" src="./img/arrow-121-32.png">
        <div id="pokecard">
           <h2 id="pokemonName_${i}">${foundPokemon['name']}</h2>
        ...
        <div class="info-container">
            ...
            <div id="pokemonAttacks" class="d-none">
            ${foundPokemon['moves'][0]['move']['name']}
            </div>

            <div id="abilities" class="abilities d-none">
            ${foundPokemon['abilities'][0]['ability']['name']}
            </div>

            <div id="stats">
                <div class="stats-class">
                    <div id="hp">${foundPokemon['stats'][0]['stat']['name']}</div>
                    <div class="progress">
                ...
                <div class="stats-class">
                    <div id="attack">${foundPokemon['stats'][1]['stat']['name']}</div>
                    <div class="progress">
                ...
                <div class="stats-class">
                    <div id="defense">${foundPokemon['stats'][2]['stat']['name']}</div>
                    <div class="progress">
                ...
                <div class="stats-class">
                    <div id="special-attack">${foundPokemon['stats'][3]['stat']['name']}</div>
                    <div class="progress">
                    ...
                    <div class="stats-class">
                    <div id="special-defense">${foundPokemon['stats'][4]['stat']['name']}</div>
                    <div class="progress">
                ...
                <div class="stats-class">
                    <div id="speed">${foundPokemon['stats'][5]['stat']['name']}</div>
                    <div class="progress">
